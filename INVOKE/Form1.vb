Public Class Form1
    ...
    '    x.AbreDadosComerciais(StrConectFA, StrConectKL, StrConectJU, MotorFA, PlataformaFA, u, p, f, "00091")
    '    x = Nothing
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        'x.AbreDadosComerciais(MotorFA, PlataformaFA, Nothing, Nothing, Nothing, Nothing, u, p, "FASTIL")
        x.AbreDadosComerciais(StrConectFA, StrConectFA.Replace("FASTIL", "KLICK"), StrConectFA.Replace("FASTIL", "JUALTEX"), MotorFA, PlataformaFA, u, p, f, "00091")
        x = Nothing
